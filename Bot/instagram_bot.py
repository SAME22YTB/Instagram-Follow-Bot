...
session = InstaPy(username = "ad.rix_sus", password = "oppelzafira05", headless_browser = True)
session.login()

#You can set max and min followers here
session.set_relationship_bounds(enabled = True, max_followers = 2000)

#Percentage from 0 to 100. 100 if you want to follow everyone who get your likes
session.set_do_follow(True, percentage=153)
